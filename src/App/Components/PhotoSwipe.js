...
var PhotoswipeWrapper = function PhotoswipeWrapper(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    className: "pswp__container ".concat(transition ? 'pswp__container_transition' : '')
  }, /*#__PURE__*/React__default.createElement("div", {
...
var styles = (function() {
  ...
  return css(_templateObject(), theme.background, skin(theme.foreground), theme.background, theme.background, theme.background, theme.background, theme.background, theme.foreground, theme.foreground, theme.foreground, theme.foreground, theme.foreground, theme.foreground, theme.background, theme.background, theme.background);
});

var PhotoSwipe = function PhotoSwipe(_ref) {
  ...
  var settings = _objectSpread2({
    ...
    history: false,
    preload: [1, 1]
  }, options); // PhotoSwipe trigger method


  var openGallery = function openGallery(i) {
    pswp.current = new photoswipe(wrapper.current, photoswipeUiDefault, container, _objectSpread2({}, settings, {
      index: i
    }));
    pswp.current.init();
    pswp.current.listen('close', function() {
      return onOpenChange(false);
    });
    pswp.current.listen('beforeChange', function() {
      return setCurrentIndex(pswp.current ? pswp.current.getCurrentIndex() : 0);
    });
    pswp.current.listen('destroy', function() {
      pswp.current = null;
    });
  }; // Go to slide #
  ...
  return jsx(React__default.Fragment, null, jsx(Global, {
    styles: styles(theme)
  }), jsx(PhotoswipeWrapper, {
    setRef: wrapper
  }, children));
};
  ...
  return jsx("div", {
    ...
    return jsx("figure", {
      ...
      onClick: function onClick(e) {
        return handleClick(e, item.uid || i);
      },
      itemProp: "contentUrl",
      "data-size": "".concat(item.w, "x").concat(item.h)
    }, jsx("img", {
      src: item.msrc,
      alt: "thumb",
      className: imgClass
...
Gallery.defaultProps = {
  ...
  onClick: function onClick(i) {
    return console.log('clicked on ', i);
  },
  wrapperClass: ''
};
